    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col gap-5 lg:flex-row  lg:gap-2 p-10">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <br />
          🏀 The Denver Nuggets have been graced by a roster of exceptional
          players who have left an indelible mark on the franchise's storied
          history. From legendary veterans to rising stars, each player has
          contributed to the Mile High legacy in their unique way.
          <br />
          ...
          <br />
          🔵🟡 #DenverNuggets #NuggetsPlayers #BasketballLegends
          #MileHighBasketball
        </div>
      </div>
    </div>
